...
int handle_page_fault(PULONG_PTR virtual_address) {
    ...
    //#### STANDBY/MODIFIED RESCUE ####
        ...
        return rescue_page(pte, virtual_address);
    ...
    // #### BRAND NEW #####
        ...
        return map_new_va(pte, virtual_address);
    ...
    //#### ON DISK ####
        ...
        return read_disk(pte, virtual_address);
...
int rescue_page(PPTE pte, PULONG_PTR virtual_address) {
...
int map_new_va(PPTE pte, PULONG_PTR virtual_address) {
...
int read_disk(PPTE pte, PULONG_PTR virtual_address) {
